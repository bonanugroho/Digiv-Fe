(function()
{
    ...
    var devicesUrl = {"general":"http://34.107.209.44/sobat-2/script_general.js?v=1599550650305"};
...
function loadTour()
{
    ...
    settings.set(TDV.PlayerSettings.WEBVR_POLYFILL_URL, 'http://34.107.209.44/sobat-2/lib/WebVRPolyfill.js?v=1599550650305');
    settings.set(TDV.PlayerSettings.HLS_URL, 'http://34.107.209.44/sobat-2/lib/Hls.js?v=1599550650305');
    settings.set(TDV.PlayerSettings.QUERY_STRING_PARAMETERS, 'v=1599550650305');
