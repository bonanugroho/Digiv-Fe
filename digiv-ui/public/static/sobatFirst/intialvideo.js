(function()
{
    ...
    var devicesUrl = {"general":"http://34.107.209.44/sobat-1/script_general.js?v=1599549887616"};
...
function loadTour()
{
    ...
    settings.set(TDV.PlayerSettings.WEBVR_POLYFILL_URL, 'http://34.107.209.44/sobat-1/lib/WebVRPolyfill.js?v=1599549887616');
    settings.set(TDV.PlayerSettings.HLS_URL, 'http://34.107.209.44/sobat-1/lib/Hls.js?v=1599549887616');
    settings.set(TDV.PlayerSettings.QUERY_STRING_PARAMETERS, 'v=1599549887616');
