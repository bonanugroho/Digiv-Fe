			...
			{isShow ? (
				<>
					<div
						...
						onClick={onClose}>
						<div className='  relative w-auto my-6 mx-auto  lg:max-w-3xl xl:max-w-3xl'>
							{/*content*/}
							<div className='modal-car-container border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none'>
								...
								{/*footer*/}
								<div className='modal-car-footer flex items-center justify-end p-6 border-t border-solid border-gray-300 rounded-b'>
